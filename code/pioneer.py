...
#  settings.SERIAL_PORT_NAME = "/dev/ttyS0"
  ...
  #settings.SERIAL_PORT_NAME = "/dev/ttyACM1"
elif os.name == "nt":
...
METER_SCALE, RADIAN_SCALE = 0.001, pi/180#2*pi/4095.0
...
#    self.flushSerialPort()
  ...
  def open(self, Serial):
    ...
    curBaudRate = 1
    self.port = Serial(self.portName,baudRates[1])
...
#      self.port.flushInput()
  ...
  def parseIO(self, recv):
    ...
    analogInputs = [a*5.0/1023.0 for a in analogInputs]
